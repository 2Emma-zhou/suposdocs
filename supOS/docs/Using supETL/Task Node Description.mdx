...
<li>Select <b>File match</b> under <b>File selection method</b> to search for files on the server. Wildcard is available.</li>
<li>Select <b>File upload</b> under <b>File selection method</b> to directly upload file as data source, and you need to save the file in UTF-8 encoding if the file contains Chinese characters.</li>
</ul>
</ul>
