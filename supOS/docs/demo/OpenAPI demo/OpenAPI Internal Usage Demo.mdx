...
Both of them you can get from **API Reference** and check the video class <a href="../class series/Open API/OpenAPI Internal Usage">Open API Internal Usage</a> to learn the method.
:::
